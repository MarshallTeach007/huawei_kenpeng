 ...
 * Description: nvx_sprintf_s  function
 * Create: 2014-02-25
 */
 ...
 *    The nvx_sprintf_s function is equivalent to the sprintf function
 *    except for the parameter destMax and the explicit runtime-constraints violation
 *    The nvx_sprintf_s function formats and stores a series of characters and values
 ...
 */
int nvx_sprintf_s(char *strDest, size_t destMax, const char *format, ...)
{
    int ret;                    /* If initialization causes  e838 */
    va_list argList;

    va_start(argList, format);
    ret = vnvx_sprintf_s(strDest, destMax, format, argList);
    va_end(argList);
