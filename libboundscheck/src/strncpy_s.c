 ...
 * Description: nvx_strncpy_s  function
 * Create: 2014-02-25
 */
/*
...
SECUREC_INLINE  errno_t CheckSrcCountRange(char *strDest, size_t destMax, const char *strSrc, size_t count)
{
    ...
    if (tmpDestMax == 0) {
        strDest[0] = '\0';
        SECUREC_ERROR_INVALID_RANGE("nvx_strncpy_s");
 ...
 errno_t strncpy_error(char *strDest, size_t destMax, const char *strSrc, size_t count)
{
    ...
    if (strDest == NULL || strSrc == NULL) {
        SECUREC_ERROR_INVALID_PARAMTER("nvx_strncpy_s");
        if (strDest != NULL) {
            strDest[0] = '\0';
 ...
 *   The nvx_strncpy_s function copies not more than n successive characters (not including the terminating null character)
 ...
 */
 errno_t nvx_strncpy_s(char *strDest, size_t destMax, const char *strSrc, size_t count)
{
    if (SECUREC_STRNCPY_PARAM_OK(strDest, destMax, strSrc, count)) {
        ...
        if (SECUREC_STRING_NO_OVERLAP(strDest, strSrc, minCpLen) || strDest == strSrc) {
            ...
            strDest[0] = '\0';
            SECUREC_ERROR_BUFFER_OVERLAP("nvx_strncpy_s");
