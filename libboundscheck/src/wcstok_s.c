 ...
 * Description: nvx_wcstok_s  function
 * Create: 2014-02-25
 */
 ...
 *   The  nvx_wcstok_s  function  is  the  wide-character  equivalent  of the nvx_strtok_s function
 *
 * <INPUT PARAMETERS>
 ...
 *   The  nvx_wcstok_s  function  is  the  wide-character  equivalent  of the nvx_strtok_s function
 */
wchar_t *nvx_wcstok_s(wchar_t *strToken, const wchar_t *strDelimit, wchar_t **context)
{
