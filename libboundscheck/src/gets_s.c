 ...
 * Description: nvx_gets_s function
 * Create: 2014-02-25
 */
 ...
 *    The nvx_gets_s function reads at most one less than the number of characters
 ...
 *    the first newline character ('\n'). nvx_gets_s then replaces the newline
 ...
 */
char *nvx_gets_s(char *buffer, size_t destMax)
{
    ...
    if (buffer == NULL || bufferSize == 0 || bufferSize > SECUREC_STRING_MAX_LEN) {
        SECUREC_ERROR_INVALID_PARAMTER("nvx_gets_s");
        return NULL;
    }
