 ...
 * Description: vswnvx_scanf_s  function
 * Create: 2014-02-25
 */
 ...
 *    The  vswnvx_scanf_s  function  is  the  wide-character  equivalent  of the vsnvx_scanf_s function
 ...
 */
int vswnvx_scanf_s(const wchar_t *buffer, const wchar_t *format, va_list argList)
{
    ...
    if (buffer == NULL || format == NULL) {
        SECUREC_ERROR_INVALID_PARAMTER("vswnvx_scanf_s");
