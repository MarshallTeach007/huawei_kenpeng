 ...
 * Description: vnvx_scanf_s  function
 * Create: 2014-02-25
 */
 ...
 *     The vnvx_scanf_s function is equivalent to nvx_scanf_s, with the variable argument list replaced by argList,
 *     The vnvx_scanf_s function reads data from the standard input stream stdin and
 ...
 */
int vnvx_scanf_s(const char *format, va_list argList)
{
    ...
    if (format == NULL || fStr.pf == NULL) {
        SECUREC_ERROR_INVALID_PARAMTER("vnvx_scanf_s");
