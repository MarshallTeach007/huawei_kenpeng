 ...
 * Description: nvx_strcpy_s  function
 * Create: 2014-02-25
 */
/*
...
SECUREC_INLINE  errno_t CheckSrcRange(char *strDest, size_t destMax, const char *strSrc)
{
    ...
    if (tmpDestMax == 0) {
        strDest[0] = '\0';
        SECUREC_ERROR_INVALID_RANGE("nvx_strcpy_s");
 ...
 errno_t strcpy_error(char *strDest, size_t destMax, const char *strSrc)
{
    ...
    if (strDest == NULL || strSrc == NULL) {
        SECUREC_ERROR_INVALID_PARAMTER("nvx_strcpy_s");
        if (strDest != NULL) {
            strDest[0] = '\0';
 ...
 *    The nvx_strcpy_s function copies the string pointed to  strSrc
 ...
 *    including the terminating null character. nvx_strcpy_s will return EOVERLAP_AND_RESET
 ...
 */
 errno_t nvx_strcpy_s(char *strDest, size_t destMax, const char *strSrc)
{
    if (SECUREC_STRCPY_PARAM_OK(strDest, destMax, strSrc)) {
        ...
        if (srcStrLen <= destMax) {
            ...
            if (SECUREC_MEMORY_NO_OVERLAP(strDest, strSrc, srcStrLen)) {
                ...
                strDest[0] = '\0';
                SECUREC_ERROR_BUFFER_OVERLAP("nvx_strcpy_s");
