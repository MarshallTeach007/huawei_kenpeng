 ...
 * Description: snvx_scanf_s  function
 * Create: 2014-02-25
 */
 ...
 *    The snvx_scanf_s function is equivalent to fnvx_scanf_s,
 ...
 */
int snvx_scanf_s(const char *buffer, const char *format, ...)
{
    int ret;                    /* If initialization causes  e838 */
    va_list argList;

    va_start(argList, format);
    ret = vsnvx_scanf_s(buffer, format, argList);
    va_end(argList);
