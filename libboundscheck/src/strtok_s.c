 ...
 * Description: nvx_strtok_s  function
 * Create: 2014-02-25
 */
 ...
 *    The nvx_strtok_s function parses a string into a sequence of strToken,
 ...
 */
char *nvx_strtok_s(char *strToken, const char *strDelimit, char **context)
{
