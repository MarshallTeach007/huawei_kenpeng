 ...
 * Description: vwnvx_scanf_s  function
 * Create: 2014-02-25
 */
 ...
 *    The  vwnvx_scanf_s  function  is  the  wide-character  equivalent  of the vnvx_scanf_s function
 *    The vwnvx_scanf_s function is the wide-character version of vnvx_scanf_s. The
 ...
 */
int vwnvx_scanf_s(const wchar_t *format, va_list argList)
{
    int retVal;                 /* If initialization causes  e838 */
    SecFileStream fStr;
    SECUREC_FILE_STREAM_FROM_STDIN(&fStr);
    if (format == NULL || fStr.pf == NULL) {
        SECUREC_ERROR_INVALID_PARAMTER("vwnvx_scanf_s");
