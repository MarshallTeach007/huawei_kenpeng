 ...
 * Description: wnvx_scanf_s  function
 * Create: 2014-02-25
 */
 ...
 *    The  wnvx_scanf_s  function  is  the  wide-character  equivalent  of the nvx_scanf_s function
 *    The wnvx_scanf_s function reads data from the standard input stream stdin and
 ...
 */
int wnvx_scanf_s(const wchar_t *format, ...)
{
    int ret;                    /* If initialization causes  e838 */
    va_list argList;

    va_start(argList, format);
    ret = vwnvx_scanf_s(format, argList);
    va_end(argList);
