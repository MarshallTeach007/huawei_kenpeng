 ...
 * Description: vsnvx_scanf_s  function
 * Create: 2014-02-25
 */
 ...
 *    The vsnvx_scanf_s function is equivalent to snvx_scanf_s, with the variable argument list replaced by argList
 *    The vsnvx_scanf_s function reads data from buffer into the location given by
 ...
 */
int vsnvx_scanf_s(const char *buffer, const char *format, va_list argList)
{
    ...
    if (buffer == NULL || format == NULL) {
        SECUREC_ERROR_INVALID_PARAMTER("vsnvx_scanf_s");
